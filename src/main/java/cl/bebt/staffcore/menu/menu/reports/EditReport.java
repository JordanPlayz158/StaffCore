...
public class EditReport extends ReportMenu {
    ...
    public EditReport(PlayerMenuUtility playerMenuUtility, StaffCorePlugin plugin, String p2, int id) {
    ...
    public void setMenuItems() {
        ...
        delete_meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "delete_report"), PersistentDataType.STRING, "delete_report");
        closeReport_meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "close_report"), PersistentDataType.STRING, "close_report");
        openReport_meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "open_report"), PersistentDataType.STRING, "open_report");
