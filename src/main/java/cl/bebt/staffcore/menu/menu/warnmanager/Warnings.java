...
public class Warnings extends Menu {
    ...
    public Warnings(PlayerMenuUtility playerMenuUtility, StaffCorePlugin plugin,
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (p.hasPermission("staffcore.warn.change")) {
            if (item.getItemMeta().getPersistentDataContainer().has(new NamespacedKey(StaffCorePlugin.plugin, "id"), PersistentDataType.INTEGER)) {
                p.closeInventory();
                int id = item.getItemMeta().getPersistentDataContainer().get(new NamespacedKey(StaffCorePlugin.plugin, "id"), PersistentDataType.INTEGER);
                String status = item.getItemMeta().getPersistentDataContainer().get(new NamespacedKey(StaffCorePlugin.plugin, "status"), PersistentDataType.STRING);
