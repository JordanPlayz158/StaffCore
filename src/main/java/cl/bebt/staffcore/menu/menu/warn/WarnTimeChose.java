...
public class WarnTimeChose extends Menu {
    ...
    public WarnTimeChose(PlayerMenuUtility playerMenuUtility, StaffCorePlugin plugin, Player p, String warned, String reason) {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem().getItemMeta().getPersistentDataContainer().has(new NamespacedKey(plugin, "default"), PersistentDataType.STRING)) {
            ...
            p.closeInventory();
            new WarnAmount(StaffCorePlugin.getPlayerMenuUtility(p), plugin, p, warned, reason).open();
            e.setCancelled(true);
    ...
    public void setMenuItems() {
        ...
        or_meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "default"), PersistentDataType.STRING, "default");
        cr_meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "specific"), PersistentDataType.STRING, "specific");
