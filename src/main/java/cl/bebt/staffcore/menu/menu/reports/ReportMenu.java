...
public class ReportMenu extends ReportPlayerMenu {
    ...
    public ReportMenu(PlayerMenuUtility playerMenuUtility, StaffCorePlugin plugin, String p2) {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem().getItemMeta().getPersistentDataContainer().has(new NamespacedKey(plugin, "other"), PersistentDataType.STRING)) {
            ...
            PlayerData.set(new NamespacedKey(StaffCorePlugin.plugin, "reportmsg"), PersistentDataType.STRING, reported);
