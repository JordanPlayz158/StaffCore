...
public class ChoseBanType extends Menu {
    ...
    public ChoseBanType(PlayerMenuUtility playerMenuUtility, StaffCorePlugin plugin, Player player, String banned, String reason) {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem().getItemMeta().getPersistentDataContainer().has(new NamespacedKey(plugin, "tempban"), PersistentDataType.STRING)) {
            p.closeInventory();
            new AmountBanned(StaffCorePlugin.getPlayerMenuUtility(p), plugin, p, banned, reason).open();
            ...
            if (e.getClick().isLeftClick()) {
                new BanMenu(playerMenuUtility, StaffCorePlugin.plugin, player, banned).open();
            }
        }
    }
    ...
    public ItemStack tempBan() {
        ...
        meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "tempban"), PersistentDataType.STRING, "tempban");
    ...
    public ItemStack permBan() {
        ...
        meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "permban"), PersistentDataType.STRING, "permban");
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack ban_ip() {
        ...
        meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "ban-ip"), PersistentDataType.STRING, "ban-ip");
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack ban_normal() {
        ...
        meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "ban-normal"), PersistentDataType.STRING, "ban-normal");
        item.setItemMeta(meta);
        return item;
    }
