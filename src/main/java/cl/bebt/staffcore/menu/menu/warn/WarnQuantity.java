...
public class WarnQuantity extends PaginatedMenu {
    ...
    public WarnQuantity(PlayerMenuUtility playerMenuUtility, StaffCorePlugin plugin, String warned, String reason, Long amount) {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem().getItemMeta().getPersistentDataContainer().has(new NamespacedKey(plugin, "seconds"), PersistentDataType.STRING)) {
            ...
            if (e.getClick().isLeftClick()) {
                new WarnAmount(playerMenuUtility, StaffCorePlugin.plugin, p, warned, reason).open();
            }
    ...
    public void setMenuItems() {
        ...
        for (String key : inventorySection.getKeys(false)) {
            ...
            meta.setLore(lore);
            meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, key), PersistentDataType.STRING, key);
