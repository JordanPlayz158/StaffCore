...
public class Amount extends PaginatedMenu {
    ...
    public Amount(PlayerMenuUtility playerMenuUtility, StaffCorePlugin plugin, Player player) {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem().getItemMeta().getPersistentDataContainer().has(new NamespacedKey(this.plugin, "amount"), PersistentDataType.INTEGER)) {
            ...
            this.player.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "amount"), PersistentDataType.INTEGER, Integer.valueOf(yep));
    ...
    public void setMenuItems() {
        ...
        for (int i = 1; i < getMaxItemsPerPage() + 1; i++) {
            ...
            meta.getPersistentDataContainer().set(new NamespacedKey(StaffCorePlugin.plugin, "amount"), PersistentDataType.INTEGER, Integer.valueOf(this.index));
