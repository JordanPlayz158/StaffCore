    ...
    public static void createWarn(String warned, String warner, String Reason, String Date, String ExpDate, String Status) {
        ...
        while (intento < 4) {
            try {
                ...
                StaffCorePlugin.plugin.getServer().getConsoleSender().sendMessage(utils.chat("&c[&5Staff Core&c] Creating the sc_warns table into the database"));
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (now.after(exp_date)) {
                    ...
                    Bukkit.getScheduler().runTaskAsynchronously(StaffCorePlugin.plugin, () -> closeWarn(WarnId));
                } else {
